...
filtered_location_api_key = location_api_key[location_api_key['state'] == "Virginia"]
...
raw_daily_transactions_table            = pd.DataFrame(dailyTransactionState).to_csv("workaxle/Data/main_raw/virginia/main_raw_dutchie_transactions.csv", date_format='%Y-%m-%d %H:%M:%S', float_format='%.2f', index=False)
raw_daily_transaction_item_table        = pd.DataFrame(dailyTransactionItemState).to_csv("workaxle/Data/main_raw/virginia/main_raw_dutchie_transaction_items.csv", date_format='%Y-%m-%d %H:%M:%S', float_format='%.2f', index=False)
raw_daily_transactions_discount_table   = pd.DataFrame(dailyTransactionsDiscountState).to_csv("workaxle/Data/main_raw/virginia/main_raw_dutchie_transaction_discounts.csv", date_format='%Y-%m-%d %H:%M:%S', float_format='%.2f', index=False)
...
while hasMore is True:
    ...
    pd.DataFrame(dailyTransactionState).to_csv("workaxle/Data/main_raw/virginia/main_raw_dutchie_transactions.csv", date_format='%Y-%m-%d %H:%M:%S', float_format='%.2f', index=False, mode="a", header=False)
    pd.DataFrame(dailyTransactionItemState).to_csv("workaxle/Data/main_raw/virginia/main_raw_dutchie_transaction_items.csv", date_format='%Y-%m-%d %H:%M:%S', float_format='%.2f', index=False, mode="a", header=False)
    pd.DataFrame(dailyTransactionsDiscountState).to_csv("workaxle/Data/main_raw/virginia/main_raw_dutchie_transaction_discounts.csv", date_format='%Y-%m-%d %H:%M:%S', float_format='%.2f', index=False, mode="a", header=False)
